...
class UsersApiController extends Controller
{
    ...
    {
        $llamadas = Llamada::select('llamadas.id','llamadas.interpreterID','llamadas.horaInicio','llamadas.horaFin','empresa_clientes.nombre','proveedors.nombre','lengua_l_e_p_s.lengua','categorias.categoria','sedes.sede')
        ...
        ->join('sedes','users.sede','=','sedes.id')
        ->get();
