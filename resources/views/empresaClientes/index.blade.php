        ...
        <table class="table table-bordered">
          <tr>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-info btn-sm" href="{{ route('empresaClientes.show', $empresaCliente->id) }}">Detalles</a>
                </td>
                <td>
                    <a class="btn btn-primary btn-sm" href="{{ route('empresaClientes.edit', $empresaCliente->id) }}">Editar</a>
                </td>
                <td>
                    {!! Form::open(['method' => 'DELETE','route' => ['empresaClientes.destroy', $empresaCliente->id],'style'=>'display:inline']) !!}
