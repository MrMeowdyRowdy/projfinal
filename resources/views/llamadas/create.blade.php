        ...
        <div class="container mt-4">
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('empresaCliente') }}"
                        type="text" 
                        class="form-control" 
                        name="empresaCliente" 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ old('especializacion') }}"
                        type="text" 
                        class="form-control" 
